...
class TelloWrapper:
    ...
    #     :return:
    #     """
    #     degree = degree #tello base is 1度
    ...
    def ob_objects_llm(self,obj_name):
        # """
        ...
        ob_list, final_obj_list, annotated_frame = self.ob_objects([obj_name])
        # 保存图片
        cv2.imwrite("ob_objects.jpg", annotated_frame)
        # #显示图片
