...
erniebot.access_token = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" #改成自己的
MY_MODEL = "ernie-4.0" #ernie-bot",ernie-bot-turbo,ernie-bot-4,ernie-bot-8k,ernie-text-embedding,ernie-vilg-v2


class ErnieAirSim:
    def __init__(self, system_prompts="system_prompts/airsim_basic_cn.txt", prompt="try.txt", example_msg=[]):
        """
        类从初始化
    ...
    def process(self, command):
        ...
        print("这是输出的代码",python_code)
        print("这是输出的回答",response)
...
if __name__=="__main__":
    ...
    example_msg = [
        ...
        {
            "role": "assistant",
            "content": """aw.fly_to([aw.get_drone_position()[0], aw.get_drone_position()[1], aw.get_drone_position()[2]+10])"""}
            # "content": """```python
    ...
    ernie_airsim = ErnieAirSim(example_msg=example_msg)  #example_msg=example_msg
    command = "起飞"
